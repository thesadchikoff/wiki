export const enum BACKEND_ENDPOINTS {
	...
	CONNECT_TELEGRAM_NOTIFY = 'users/connect-telegram-notify',
	DISCONNECT_TELEGRAM_NOTIFY = 'users/disconnect-telegram-notify',
	TOGGLE_TELEGRAM_NOTIFY = 'users/toggle-telegram-notify',
	TOGGLE_EMAIL_NOTIFICATION = 'users/toggle-email-notification',
